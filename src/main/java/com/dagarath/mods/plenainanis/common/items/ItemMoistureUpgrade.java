 ...
 */
public class ItemMoistureUpgrade extends Item {

    public IIcon[] icons = new IIcon[3];
    public String[] names = {"minor", "average", "major"};

    public ItemMoistureUpgrade(){
        super();
        this.setUnlocalizedName("moisture");
    ...
    public void registerIcons(IIconRegister reg){
        for(int i = 0; i < 3; i ++){
            this.icons[i] = reg.registerIcon(PlenaInanisReference.MODID + ":moisture_" + names[i]);
        }
    }
